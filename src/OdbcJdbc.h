...
// Ensure thread safety is always enabled — DRIVER_LOCKED_LEVEL_NONE (0) is not supported
#if DRIVER_LOCKED_LEVEL < DRIVER_LOCKED_LEVEL_ENV
#error "DRIVER_LOCKED_LEVEL must be DRIVER_LOCKED_LEVEL_ENV (1) or DRIVER_LOCKED_LEVEL_CONNECT (2)"
#endif
