...
***/
NITEM (SQL_GETDATA_EXTENSIONS, (SQL_GD_ANY_COLUMN | SQL_GD_ANY_ORDER | SQL_GD_BLOCK | SQL_GD_BOUND | SQL_GD_OUTPUT_PARAMS))
NITEM (SQL_ASYNC_MODE, SQL_AM_NONE)
NITEM (SQL_ASYNC_DBC_FUNCTIONS, SQL_ASYNC_DBC_NOT_CAPABLE)
...
// No ODBC escape sequence processing — use native Firebird JOIN syntax
...
// Escape sequence scalar functions are NOT supported — SQL is passed through to Firebird as-is
NITEM (SQL_NUMERIC_FUNCTIONS, 0)
NITEM (SQL_CONVERT_FUNCTIONS, SQL_FN_CVT_CAST) // CAST is native SQL, not an escape
