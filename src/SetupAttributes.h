...
#define MAJOR_VERSION 		ODBC_VERSION_MAJOR
#define MINOR_VERSION 		ODBC_VERSION_MINOR
#define REVNO_VERSION 		ODBC_VERSION_PATCH
#define BUILDNUM_VERSION	ODBC_VERSION_TWEAK
...
#define SETUP_CONNSETTINGS "ConnSettings"
...
#define KEY_DSN_CONNSETTINGS "CONNSETTINGS"
...
#define FILE_VERSION_STR	BUILD_VERSION_STR( BUILD_STR2( MAJOR_VERSION ), BUILD_STR2( MINOR_VERSION ), BUILD_STR2(REVNO_VERSION), BUILD_STR2(BUILDNUM_VERSION) ) "\0"
