...
NITEM (SQL_CONVERT_BIGINT, (SQL_CVT_SMALLINT|SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL))
NITEM (SQL_CONVERT_LONGVARBINARY, (SQL_CVT_CHAR))
NITEM (SQL_CONVERT_BINARY, 0)
NITEM (SQL_CONVERT_LONGVARCHAR, (SQL_CVT_CHAR))
NITEM (SQL_CONVERT_BIT, 0)
NITEM (SQL_CONVERT_NUMERIC, (SQL_CVT_SMALLINT|SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_CHAR|SQL_CVT_BIGINT|SQL_CVT_DECIMAL))
NITEM (SQL_CONVERT_CHAR, (SQL_CVT_SMALLINT|SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_BIGINT|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL|SQL_CVT_DATE|SQL_CVT_TIMESTAMP))
NITEM (SQL_CONVERT_REAL, (SQL_CVT_SMALLINT|SQL_CVT_DOUBLE|SQL_CVT_BIGINT|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL))
NITEM (SQL_CONVERT_DATE, (SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_BIGINT|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL|SQL_CVT_TIME|SQL_CVT_TIMESTAMP))
NITEM (SQL_CONVERT_SMALLINT, (SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_BIGINT|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL))
NITEM (SQL_CONVERT_DECIMAL, (SQL_CVT_SMALLINT|SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_CHAR|SQL_CVT_BIGINT|SQL_CVT_NUMERIC))
NITEM (SQL_CONVERT_TIME, (SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_BIGINT|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL|SQL_CVT_DATE|SQL_CVT_TIMESTAMP))
NITEM (SQL_CONVERT_DOUBLE, (SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_SMALLINT|SQL_CVT_BIGINT|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL))
NITEM (SQL_CONVERT_TIMESTAMP, (SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_BIGINT|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL|SQL_CVT_DATE|SQL_CVT_TIME))
NITEM (SQL_CONVERT_FLOAT, (SQL_CVT_SMALLINT|SQL_CVT_DOUBLE|SQL_CVT_BIGINT|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL))
NITEM (SQL_CONVERT_TINYINT, (SQL_CVT_SMALLINT|SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_BIGINT|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL))
NITEM (SQL_CONVERT_INTEGER, (SQL_CVT_SMALLINT|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_BIGINT|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL))
NITEM (SQL_CONVERT_VARBINARY, 0)
NITEM (SQL_CONVERT_INTERVAL_YEAR_MONTH, 0)
NITEM (SQL_CONVERT_VARCHAR, (SQL_CVT_SMALLINT|SQL_CVT_INTEGER|SQL_CVT_FLOAT|SQL_CVT_DOUBLE|SQL_CVT_BIGINT|SQL_CVT_CHAR|SQL_CVT_NUMERIC|SQL_CVT_DECIMAL|SQL_CVT_DATE|SQL_CVT_TIMESTAMP))
...
NITEM (SQL_SCROLL_CONCURRENCY, (SQL_SCCO_READ_ONLY | SQL_SCCO_OPT_VALUES))
