...
UITEM (SQL_SEARCH_PATTERN_ESCAPE, 0)
UITEM (SQL_SERVER_NAME, 0)
UITEM (SQL_FILE_USAGE, 0)
...
UITEM (SQL_ORDER_BY_COLUMNS_IN_SELECT, 0)
...
UITEM (SQL_MAX_PROCEDURE_NAME_LEN, 0)
...
UITEM (SQL_NUMERIC_FUNCTIONS, 0)
UITEM (SQL_TIMEDATE_DIFF_INTERVALS, 0)
UITEM (SQL_STRING_FUNCTIONS, 0)
UITEM (SQL_TIMEDATE_FUNCTIONS, 0)
UITEM (SQL_SYSTEM_FUNCTIONS, 0)
