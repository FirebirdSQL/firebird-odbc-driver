...
protected:
    ...
    static void SetUpTestSuite() {
        // All tests in this file require Phase 0 crash prevention fixes.
        // Skip the DLL loading entirely — the driver DLL name (FirebirdODBC.dll)
        // doesn't exist on vanilla master and the driver crashes on NULL handles.
        // The GTEST_SKIP() in each test handles the per-test skip message.
        //
        // Original code loaded the driver DLL directly:
...
{
    GTEST_SKIP() << "Requires Phase 0: crash prevention (NULL handle checks not yet merged)";
