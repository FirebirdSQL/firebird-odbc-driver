...
// OdbcString is introduced in Phase 12 and doesn't exist on vanilla master.
// All tests in this file are SKIP'd until Phase 12 is merged.

#include <gtest/gtest.h>

#if __has_include("OdbcString.h")
#include "OdbcString.h"
#define HAS_ODBC_STRING 1
using namespace OdbcJdbcLibrary;
#else
#define HAS_ODBC_STRING 0
#endif
...
protected:
    void SetUp() override {
#if !HAS_ODBC_STRING
        GTEST_SKIP() << "Requires Phase 12: OdbcString class (not yet merged)";
#endif
    }
};
