...
Source: "{#sourceDll}IscDbc.dll"; DestDir: "{app}"
Source: "{#sourceDll}OdbcJdbc.dll"; DestDir: "{app}"
Source: "{#sourceDll}OdbcJdbcSetup.dll"; DestDir: "{app}"
...
[Run]
Filename: "{sys}\regsvr32.exe"; Parameters: """{app}""/OdbcJdbcSetup.dll"
